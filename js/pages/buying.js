				...
				success: function(data, textStatus, XMLHttpRequest) {
					...
					data.forEach(function(item, i, arr) {
						...
						+ '<div class="col-xs-1 text-xs-center">'
							+ '<div class="cursor-pointer track-this-item' + (typeof local_storage['buying_track_list'][item['id']] !== "undefined" ? ' text-info' : '') + '" data-item-id="' + item['id'] + '" data-item-vnum="' + item['item_id'] + '" data-item-count="' + item['quantity'] + '" data-item-price="' + item['price'] + '" title="' + chrome.i18n.getMessage("notify_when_bought") + '">'
